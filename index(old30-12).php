...
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/pt_BR/sdk.js#xfbml=1&version=v8.0" nonce="9gdaVeOT"></script>
    ...
    <div class="col social-sup align-middle">
     ...
     <!-- youtube -->
     <a href="http://bit.ly/youtubePMMCOVID" target="_blank" class="btn-circle">
      ...
      <!-- whatsapp -->
      <a href="http://bit.ly/whatsappPMM" target="_blank" class="btn-circle">
      ...
      <!-- Facebook -->
      <a href="http://bit.ly/PrefMesquitafb" target="_blank" class="btn-circle" ><i class="fa fa-facebook " aria-hidden="true"></i>
      ...
      <!-- instagram -->
      <a href="http://bit.ly/PrefMesquitaInst" target="_blank" class="btn-circle">
                              <i class="fa fa-instagram " aria-hidden="true"></i>
                              
                          
        </a>
      <!-- twitter-->
      <a href="http://bit.ly/PrefMesquitaTw" target="_blank" class="btn-circle">  <i class="fa fa-twitter " aria-hidden="true"></i>
                      
                                          
        </a>   
      <!-- linkedin -->
      <a href="http://bit.ly/linkedinPMM" target="_blank" class="btn-circle">
