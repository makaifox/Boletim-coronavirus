...
class Upload{
    ...
    function __construct($arquivo,  $pasta){
        ...
        // $this->altura  = $altura  $altura, $largura,;
    ...
    private function ehArquivo($extensao){
        $extensoes = array('txt', 'pdf', 'doc', 'docx', 'jpg', 'jpeg', 'gif', 'png', 'ppt', 'pps', 'xls', 'xlsx', 'bmp');	 // extensoes permitidas
    ...
    public function salvar(){
        ...
        // if ($this->ehArquivo($extensao)){
        //     //pega a largura, altura, tipo e atributo da imagem
        //     list( $tipo, $atributo) = getimagesize($destino);
