                ...
                <div class="col-lg-4 col-sm-6 card-mob ">
                    <div class="card-box bg-white">
                        <div class="inner inner-size">
                            <h3 class="orange"> 5527 </h3>
                            <p class="orange"> PESSOAS VACINADAS </p>
                            <h3 class="orange"> 2488 </h3>
                    ...
                    <br>
                        <div class="form-group">
                            ...
                            <select style="width: 100%;" name="secretaria" class="form-control option motivo">
                                ...
                                <option value="SEMGOV-FINANCAS">SEMGOV - SUBSECRETARIA DE ORÇAMENTO E FINANÇAS</option>
                                <option value="SEMGOV-COMPRAS">SEMGOV - SUBSECRETARIA DE COMPRAS, SERVIÇOS E LOGÍSTICA</option>
                                <option value="SEMGOV-PLANEJAMENTO">SEMGOV - SUBSECRETARIA DE PLANEJAMENTO ESTRATÉGICO E GESTÃO</option>
                                <option value="SEMGOV-FAZENDA">SEMGOV - SUBSECRETARIA DE FAZENDA</option>
                                <option value="SEMGOV-T.I">SEMGOV - SUBSECRETARIA DE TECNOLOGIA DA INFORMAÇÃO</option>
                                ...
                                <option value="SEMGOV-LAZER">SEMGOV - SUBSECRETARIA DE LAZER</option>
                                ...
                                <option value="CCS">CCS - COORDENADORIA DE COMUNICAÇÃO SOCIAL</option>
                                <option value="OUVIDORIA">OUVIDORIA</option>
                                <option value="PROCON">PROCON</option>
                                <option value="MESQUITAPREV">MESQUITAPREV</option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="custom-file-input" id="customFile" name="anexo"  size="45">
                            <label class="custom-file-label" for="anexo">Nenhum arquivo selecionado</label>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-lg-3 mx-auto my-md-4 my-0 mt-4 mb-1 ">
                    ...
                    <div class="d-flex justify-content-around">
                        ...
                        <div class="fb-page" data-href="https://www.facebook.com/prefmesquitaboletimcovid19/" data-tabs="timeline" data-width="425" data-height="325" data-small-header="true" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true">
                            <blockquote cite="https://www.facebook.com/prefmesquitaboletimcovid19/" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/prefmesquitaboletimcovid19/">Prefeitura de Mesquita Boletim Coronavirus</a></blockquote>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 col-lg-3 mx-auto my-md-4 my-0 mt-4 mb-1 ">
                    ...
                    <div class="d-flex justify-content-around">
                        ...
                        <a class="twitter-timeline" data-width="420" data-height="320" href="https://twitter.com/mesquitarj">Tweets by pmmcovid19</a>
