...
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/pt_BR/sdk.js#xfbml=1&version=v8.0" nonce="9gdaVeOT"></script>
    ...
    <div class="col img_mobile"><img src="./img/logo-boletimcorona.png" class="logo img-fluid" style="max-width: 8rem;" ></div>
    <div class="col ">
            
            <div class="align-middle" id="inicio">Última atualização: <?= $hoje; ?></div>

    </div>
    <div class="col social-sup align-middle">
                       
     <!-- youtube -->
     <a href="https://www.youtube.com/channel/UCXgKyvQithT0D1IrEsMMfrg?view_as=subscriber&sub_confirmation=1"  target="_blank" class="btn-circle">
      ...
      <!-- whatsapp -->
      <a href="https://chat.whatsapp.com/HQ6ES5kycNA8aVJDN3Lnz8"  target="_blank" class="btn-circle">
      ...
      <!-- Facebook -->
      <a href="https://bit.ly/3fWbhfC"  target="_blank" class="btn-circle" ><i class="fa fa-facebook " aria-hidden="true"></i>
      ...
      <!-- twitter-->
      <a href="https://twitter.com/pmmcovid19"  target="_blank" class="btn-circle"> <i class="fa fa-twitter " aria-hidden="true"></i>
                      
                                          
        </a>   
      <!-- linkedin -->
      <a href="https://www.linkedin.com/company/prefeitura-de-mesquita-boletim-coronav%C3%ADrus/"  target="_blank" class="btn-circle">
  ...
  <div class="carousel-inner">
    ...
    interval: 5000
        ...
        <nav class="navbar navbar-expand-lg purple-bar d-flex " id="navbar_top" >
            ...
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Alterna navegação">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <li class="nav-item princ"><a class="nav-link princ" href="#inicio"> <i class="fa fa-home"></i> Início</a></li>
                    <li class="nav-item princ"><a class="nav-link princ" href="#Últimosdados"> <i class="fa fa-exclamation-triangle"></i> Últimos dados</a></li>
                    <li class="nav-item princ"><a class="nav-link princ" href="#sobre"><i class="fa fa-university"></i> Sobre o portal</a></li>
                    <li class="nav-item princ"><a class="nav-link princ" href="#noticias"> <i class="fa fa-newspaper-o"></i> Últimas notícias</a></li>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="#grupos_de_risco"> <i class="fa fa-angle-right"></i> Grupo de risco</a>
                        </div>
                    </li>
                    ...
                    <li class="nav-item princ"><a class="nav-link princ" href="#grafico"> <i class="fa fa-bar-chart"></i> Gráfico de contaminação</a></li>
                        ...
                        <li class="nav-item princ"><a class="nav-link princ" href="http://www.mesquita.rj.gov.br/pmm/"> <i class="fa fa-reply"></i> Voltar</a></li>
    ...
    <div class="cards  d-flex justify-content-around" id="Últimosdados">
        

                <div class="cards  d-flex justify-content-around ">
                
                <h1 class="display-4">Últimos dados (Mesquita/RJ)<br><a style="color: #3e276a; font-size:16px; text-decoration: underline" href="http://coronavirus.mesquita.rj.gov.br/coronaapp1_list.php" target="_blank">Fonte : www.coronavirus.mesquita.rj.gov.br/</a>
		<p style="color: #ff0000; font-size:16px" >Dados coletados a partir da data : 02/03/2020</p>
                 </h1>   
                </div>
</div>

    <div class="container-fluid .horizontal-center  Últimos">
...
<!--
                    ...
                    <div class="card cards-dados ">
                        <h4 class="card-title total-mortos-titulo">Descartados Clínicos</h4>
                        <div class="card-content">
    ...
    <div class=" horizontal-center">
        <div class="card"> 
            ...
            <div class="card-body sobre">
                    <p>O Boletim Coronavírus é um site de acesso livre, onde o cidadão mesquitense pode encontrar informações sobre dados da Covid-19 no município e seus assuntos relacionados. Seu conteúdo é atualizado diariamente, para informar a população de maneira eficiente.</p> </div> 
    ...
    <div class=" horizontal-center">
        <div class="card"> 
            ...
            <div class="cards  d-flex justify-content-around" id="noticias">
                ...
                <h1 class="display-4 noticiasTitle">Últimas notícias</h1>
...
<div class="container ">
    <div id="accordion" class="accordion">
        <div class="card mb-0">
            ...
            <p class="prevencao-p">
            A recomendação principal para prevenir a covid-19 é evitar aglomerações. 
            ...
            <div id="collapseThree" class="collapse" data-parent="#accordion">
                ...
                <br>Porém, é importante frisar que existem pacientes assintomáticos.
            ...
            <div class="card-header collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseSix" id="grupos_de_risco">
       ...
       <div class="card"> 
            ...
            <h4>Dados exclusivamente de Mesquita/Rj<br><br> Atualizados mensalmente! Fonte : <a href="http://coronavirus.mesquita.rj.gov.br/coronaapp1_list.php">Link</a></h4>
            ...
            <div class="card-body fale-conosco">
				...
				<option value="Outros">Outros</option>
                        ...
                        <div class="form-group">
                                ...
                                ?>
                                <input style="padding: 12px;" type="text" name="email" class="form-control" placeholder="exemplo@exemplo.com.br"><br>
                            </div> 
                        ...
                        <input style="margin-bottom: 10px;" placeholder="21999999" type="text" name="cep" onkeypress="$(this).mask('00000-000');">
...
<footer class="page-footer font-small mdb-color lighten-3 pt-4">
  ...
  <div class="container text-center text-md-left">
    ...
    <div class="row">
      ...
      <h5 class="font-weight-bold text-uppercase mb-4" >Menu Principal </h5>
        ...
        <ul class="navbar-nav mx-auto order-0 ">
        <li class="nav-item princ princ-bottom"><a class="nav-link princ" href="#inicio"> <i class="fa fa-home"></i> Início</a></li>
        <li class="nav-item princ princ-bottom"><a class="nav-link princ" href="#Últimosdados"> <i class="fa fa-home"></i> Últimos dados</a></li>
                    <li class="nav-item princ princ-bottom"><a class="nav-link princ" href="#sobre"><i class="fa fa-university"></i> Sobre o portal</a></li>
                    <li class="nav-item princ princ-bottom"><a class="nav-link princ" href="#noticias"> <i class="fa fa-newspaper-o"></i> Últimas notícias</a></li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle princ princ-bottom" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-heartbeat"></i> Covid-19</a>
                        <div class="dropdown-menu">
                            <a class="dropdown-item " href="#prevencao"><i class="fa fa-angle-right"></i> Prevenção</a>
                            <a class="dropdown-item " href="#transmissao"> <i class="fa fa-angle-right"></i> Transmissão</a>
                            <a class="dropdown-item " href="#sintomas"> <i class="fa fa-angle-right"></i> Sintomas</a>
                            <a class="dropdown-item " href="#atendimento"> <i class="fa fa-angle-right"></i> Atendimento</a>
                            <a class="dropdown-item " href="#tratamento"> <i class="fa fa-angle-right"></i> Tratamento</a>
                            <a class="dropdown-item " href="#grupos_de_risco"> <i class="fa fa-angle-right"></i> Grupos de risco</a>
                        </div>
                    </li>

                    
                    <li class="nav-item princ princ-bottom"><a class="nav-link princ " href="#grafico"> <i class="fa fa-bar-chart"></i> Gráfico de contaminação</a></li>
                    
                        <li class="nav-item princ princ-bottom"><a class="nav-link princ" href="#fale_conosco"> <i class="fa fa-comment"></i> Fale conosco</a></li>
 ...
 <div class="col-md-4 col-lg-3 mx-auto my-md-4 my-0 mt-4 mb-1 ">
  ...
  © 2020 | Todos os Direitos Reservados | PMM - Prefeitura Municipal de Mesquita | RJ | CNPJ: 04.132.090/0001-25
  <br>
Desenvolvimento:<br>
